...
| 主题 | 背景色 | 类型 |
|------|--------|------|
| 水生 Aquatic | `#202020` | 暗色 |
| 黄昏 Dusk | `#2d3236` | 暗色 |
| 夜空 Night Sky | `#000000` | 暗色 |
| 沙漠 Desert | `#fffaef` | 明亮 |
...
└── themes/                         # Windows 11 系统原始主题文件
    ├── hcblack-aquatic.theme       # 水生 Aquatic（暗色）
    ├── hcwhite-desert.theme        # 沙漠 Desert（明亮）
    ├── hc1-dusk.theme              # 黄昏 Dusk（暗色）
    └── hc2-night-sky.theme         # 夜空 Night Sky（暗色）
```
